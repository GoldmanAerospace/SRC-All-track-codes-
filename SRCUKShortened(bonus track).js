...
var qualification_duration = 15000;
var race_laps = 10;
...
var SpawnX = -355; var SpawnY = 200; var StartX = -178; var StartY = 155;
/*
...
var Sector1X = StartX+40; var Sector1Y = StartY;
var Sector2X = 145; var Sector2Y = -175;
var Sector3X = -420;  var Sector3Y = -105;
...
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //8
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //9
"9999999999999999999999999999999999999999999999999999999999955555555555555599999999999999999999999999\n"+    //20
"9999999999999999999999999999999999999999999999999999999995555555555555555555599999999999999999999999\n"+ //1
"9999999999999999999999999999999999999999999999999999999955555555555555555555559999999999999999999999\n"+ //2
"9999999999999999999999999999999999999999999999999999999555555555555555555555555999999999999999999999\n"+ //3
"9999999               999999999999999999999999999999995555599999999999999995555599999999999999999999\n"+ //4
"9999999               999999999999999999999999999999955555999999999999999999555599999999999999999999\n"+ //5
"9999999               999999999999999999999999999999955559999999995555559999555559999999999999999999\n"+ //6
"9999999               999999999999999999999999999999955559999999555555555999955559999999999999999999\n"+ //7
"9999999               999999999999999999999999999999955555999955555555555599955555999999999999999999\n"+ //8
"999999999U9999U9999U99999999999999999999999999999999995555555555559999555599995555599999999999999999\n"+ //9
"999999999           99999999999999999999999999999999999555555555599999555599995555599999999999999999\n"+    //30
"999999999999    999999999999999999999999999999999999999955555555999995555599999555559999999999999999\n"+ //1
"999999999999  D 999999999999999999999999999999999999999999955599999955555999999555559999999999999999\n"+ //2
"99999999999999RRR                  99999999999999999999999999999999955555999999955555999999999999999\n"+ //3
"99999999999        B B B B B B       999999999999999999999999999999555559999999955555999999999999999\n"+ //4
"999999999                       I     99999999999999999999999999999555599999999995555599999999999999\n"+ //5
"9999999    T     T  B B B B B B        9999999999999999999999999999555599999999999555559999999999999\n"+ //6
"999999                                  999999999999999999999999999555599999999999955555999999999999\n"+ //7
"99999      9999999999999999999999999DDDDD99999999999999999999999999555599999999999995555599999999999\n"+ //8
"9999     999999999999999999999999999     99999999999999999999999999555599999999999999555559999999999\n"+ //9
"999     999          Q            999     9999999999999999999999999555599999999999999955555999999999\n"+    //40
"99     999         99999         D 99     9999999999999999999999999555599999999999999995555599999999\n"+ //1
"9     999   999999999999999999999  99     9999999999999999999999999555599999999999999999555559999999\n"+ //2
"9    999   99999999999999999999999  9     9999999999999999999999999555599999999999999999955559999999\n"+ //3
"9UUUU999DD999999999999999999999999  99     999999999999999999999999555599999999999999999955559999999\n"+ //4
"9    99  9999999999999999999999999  99DDDDD999999999999999999999999555599999999999999999955559999999\n"+ //5
"99    99  999999999999999999999999  99     999999999999999999999999555599999999999999999555559999999\n"+ //6
"999     Q 999999999999999999999999  99      99999999999999999999999555599999999999999995555559999999\n"+ //7
"999       999999999999999999999999 Q     R      9999999999999999999555599999999999999955555599999999\n"+ //8
"999999 L  999999999999999999999999                  999999999999999555599999999999999555555999999999\n"+ //9
"999999 L  9999999999999999999999999999999               99999999999555599999999999995555559999999999\n"+    //50
"999999    99999999999999999999999999999999999               9999999555599999999999955555599999999999\n"+ //1
"999999    999999999999999999999999999999999999999      R     999999555599999999999555555999999999999\n"+ //2
"999999    9999999999999999999999999999999999999999999        999999555599999999995555559999999999999\n"+ //3
"999999    99999999999999999999999999999999999999999999999    999999555599999999955555599999999999999\n"+ //8
"999999    9999999999999999999999999999999999999999999999     999999555599999999555555999999999999999\n"+ //9
"999999    999999999999999999999999999999999999999999999  L  9999999555599999995555559999999999999999\n"+    //60
"999999    9999999999999999999999999999999999999999999      99999999555599999955555599999999999999999\n"+ //1
"999999    999999999999999999999999999999999999999999     9999999999555599999555555999999999999999999\n"+ //2
"999999UUUU99999999999999999999999999999999999999999    999999999999999999995555559999999999999999999\n"+ //3
"999999    9999999999999999999999999999999999999999    9999999999999999999955555599999999999999999999\n"+ //4
"999999    9999999999999999999999999999999999999999                 999999555555999999999999999999999\n"+ //5
"999999    9999999999999999999999999999999999999999   R   R   R      99999555559999999999999999999999\n"+ //6
"999999    99999999999999999999999999999999999999999                 99995555599999999999999999999999\n"+ //7
"999999   99999999999999999999999999999999999999999999999999999999   99995555999999999999999999999999\n"+ //8
"99999    99999999999999999999999999999999999999999999999999999999   99955559999999999999999999999999\n"+ //9
"99999    99999999999999999999999999999999999999999999999999999999   99955559999999999999999999999999\n"+    //70
"99999UUUU99999999999999999999999999999999999999999999999999999      99955599999999999999999999999999\n"+ //1
"99999                                          L  99999999999       99955599999999999999999999999999\n"+ //2
"999999                                         L   999999999       999955999999999999999999999999999\n"+ //3
...
game.setObject({
  id: "ShipsGallery",
  type: ShipsGallery,
  position: {x:SpawnX+50,y:SpawnY+45,z:-2.5},
...
game.setObject({
  id: "AboutMod",
  type: AboutMod,
  position: {x:SpawnX,y:SpawnY+45,z:-2.5},
  scale: {x:49,y:49,z:36},
  rotation: {x:600,y:0,z:0}
}) ;
...
this.options = {
  ...
  starting_ship: 800,
  auto_refill: false,
  map_name: "7th SRC track/"+map_name_type,
  projectile_speed: 3,
  speed_mod: 1,
...
warn = function(ship_number, rule, time = 25, character = "Zoltar") {
  if (rule < 1 || rule > 5) {
    error("Unknown rule number (should be 1 to 5)");
    return;
  }
  rule--;
...
this.tick = function(game) {
  ...
  if (game.custom.enable_drs) {
    if (game.step%605 == 0) {
      //DRSZONE 1
      game.addCollectible({code:90,x:-375,y:145});
      game.addCollectible({code:90,x:-365,y:145});
      game.addCollectible({code:90,x:-355,y:145});
      game.addCollectible({code:90,x:-345,y:145});
      game.addCollectible({code:90,x:-335,y:145});
      //DRSZONE 2
      game.addCollectible({code:90,x:190,y:-55});
      game.addCollectible({code:90,x:190,y:-35});
      game.addCollectible({code:90,x:190,y:-15});
      game.addCollectible({code:90,x:190,y:5});
      game.addCollectible({code:90,x:190,y:25});
      //DRSZONE 3
      game.addCollectible({code:90,x:-75,y:-195});
      game.addCollectible({code:90,x:-95,y:-195});
      game.addCollectible({code:90,x:-115,y:-195});
      game.addCollectible({code:90,x:-135,y:-195});
      game.addCollectible({code:90,x:-155,y:-195});
    }
  }
