...
var qualification_duration = 900; // 180 for public event
var race_laps = 11; //4 for public event
var race_start_delay = 11;
var race_start_countdown = 6;
var race_close_time = 100; //20 for public event
...
for (let track of tracks) {
  TrackInfo[track.sname] = {
    ...
    obj: "https://starblast.data.neuronality.com/mods/objects/plane.obj",
    diffuse: "https://raw.githubusercontent.com/mrGoldmanus/RACING-/master/abouttrack"+ track.sname +".png",
    emissive: "https://raw.githubusercontent.com/mrGoldmanus/RACING-/master/abouttrack"+ track.sname +".png"
  };
}
