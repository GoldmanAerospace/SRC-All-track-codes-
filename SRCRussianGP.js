...
var qualification_duration = 1100 ;
var race_laps = 18 ;
...
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //12
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //13
"99999999999999999999999999     R       9999999999999999999999999999999999999999999999999999999999999\n"+ //14
...
"99         R          99999999        99999999       99999999999999999999999999999999999999999999999\n"+ //23
"9          R        999999999    L     99999999       9999999999999999999999999999999999999999999999\n"+ //24
"9          R       99999999      L       99999999       99999999999999999999999999999999999999999999\n"+ //25
"9UUUU999999999999999999999                 99999999       999999999999999999999999999999999999999999\n"+ //26
"9    9999999999999999999       99999        9999999999      9999999999999999999999999999999999999999\n"+ //27
"9    99999999999999999       999999999        999999999      999999999999999999999999999999999999999\n"+ //28
"9    9999999999999999       999999999999       999999999  H  999999999999999999999999999999999999999\n"+ //29
"9    999999999999999 DDDD 999999999999999      999999999  D  999999999999999999999999999999999999999\n"+    //30
"9    99999999999999      99999999999999999 UUUU 99999999     999999999999999999999999999999999999999\n"+ //31
"9    9999999999999     99999999999999999999      9999999     999999999999999999999999999999999999999\n"+ //32
"9    999999999999     9999999999999999999999      999999     999999999999999999999999999999999999999\n"+ //33
"9    99999999999 DDDD 9999999999999999999999      999999     999999999999999999999999999999999999999\n"+ //34
"9UUUU99999999999     999999999999999999999999      99999     999999999999999999999999999999999999999\n"+ //35
"9    9999999999     99999999999999999999999999     99999     999999999999999999999999999999999999999\n"+ //36
"9    9999999999     99999999999999999999999999     99999     999999999999999999999999999999999999999\n"+ //37
...
"9          L         9999999999999999999999999UUUUU9999999       9999    99999999999999     99999999\n"+ //48
"99         L        99999999999999999999999999       9999999       99UUUU999999999999999    99999999\n"+ //49
"9999999999999999999999999999999999999999999999         9999999           999999999999999    99999999\n"+    //50
"999999999999999999999999999999999999999999999999    M    9999999         999999999999999    99999999\n"+ //51
...
"999999999999999999999999999999999999999999999999999999         999999999999999999999999 DDD 99999999\n"+ //54
...
"999999999999999999999999999999999999999999999999999999999999999999999   L   B B B B B B    999999999\n"+ //61
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999U999999999\n"+
"99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999UU999999999\n"+//62
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999   99UU999999999\n"+ //63
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999    ---999999999\n"+ //64
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999       999999999\n"+ //65
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999       999999999\n"+ //66
"9999999999999999999999999999999999999999999999999999999999999999999999999     9     DD99999999999999\n"+ //67
"9999999999999999999999999999999999999999999999999999999999999999999999999           9R     999999999\n"+ //68
"9999999999999999999999999999999999999999999999999999999999999999999999999           9R     999999999\n"+ //69
"9999999999999999999999999999999999999999999999999999999999999999999999999     9     9R     999999999\n"+    //70
"9999999999999999999999999999999999999999999999999999999999999999999999999     9     9R     999999999\n"+ //71
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999R     999999999\n"+ //72
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //73
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //74
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //75
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //76
...
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999", 
checkpoints: [
  {x:229,y:-85,direction:180,width:90}, // Start/ finish line
  ...
  if (vehicle_type == spr) {
    if (!ship.custom.instructor_hidden) {
      if (!ship.custom.instructor_said) {
        ...
        ship.instructorSays("Today is sprint race. Short distance, powerful boosters, closed pit lane, and only 1 booster slot. Intense race and important qualification position. Good luck!", "Zoltar");
  ...
  if (vehicle_type == end) {
    if (!ship.custom.instructor_hidden) {
      if (!ship.custom.instructor_said) {
        ship.custom.instructor_said = true;
        ship.custom.instructor_hide_step = game.step + 1200;
        ship.instructorSays("Today is endurance race. Long distance. Position in qualification is not so important. Weaker boosters, but 2 weapon/booster slots, and an open pitlane with mines and missiles in the race. Good luck!", "Zoltar");
      } else if (game.step >= ship.custom.instructor_hide_step) {
        ship.custom.instructor_hidden = true;
        ship.hideInstructor();
      }           
...
var updateShipInfo = function(ship,game) { 
  if (game.custom.status == "qualification" && ship.x > 390 && ship.x < 410 && ship.y > -170 && ship.y < -150) {
...
var createStartingGrid = function(game) {
  var x = 260 ;// Pole position ship X coordinate
  ...
  for (var i=0;i<game.ships.length;i++)
  {
    ...
    if (i%2 ==0)
    {
      ship.set({x:x,y:-85,vx:0,vy:0,idle:true,angle:180,generator:200}) ;
    }
    else
    {
      ship.set({x:x,y:-105,vx:0,vy:0,idle:true,angle:180,generator:200}) ;
    }
    x = Math.max(260,x+10) ; // (Pole position coordinate, x+10 / x-10 distance with position down)
  }
}
...
this.tick = function(game) {
  ...
  if (game.step%605 == 0) {
    //DRSZONE 1
    game.addCollectible({code:90,x:105,y:-48});
    game.addCollectible({code:90,x:87,y:-37});
    game.addCollectible({code:90,x:69,y:-26});
    game.addCollectible({code:90,x:51,y:-16});
    game.addCollectible({code:90,x:190,y:365});
    game.addCollectible({code:90,x:230,y:365});
    //DRSZONE 2
    game.addCollectible({code:90,x:85,y:195});
    game.addCollectible({code:90,x:85,y:165});
    game.addCollectible({code:90,x:85,y:135});
    game.addCollectible({code:90,x:85,y:105});
    game.addCollectible({code:90,x:85,y:75});
  } 
  // PitLane
  
  if (vehicle_type != spr && game.custom.status != "qualification") {
    if (game.step%1350 == 0) {  
      game.addCollectible({code:20,x:255,y:-55});
      game.addCollectible({code:11,x:265,y:-55});
      game.addCollectible({code:20,x:305,y:-55});
      game.addCollectible({code:11,x:315,y:-55});
    }
    else if (game.step%1350 == 650) {
      game.addCollectible({code:10,x:255,y:-55});
      game.addCollectible({code:21,x:265,y:-55});
      game.addCollectible({code:10,x:305,y:-55});
      game.addCollectible({code:21,x:315,y:-55});
  }
 }  
} ;
