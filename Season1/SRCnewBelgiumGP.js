...
var SpawnX = -220; var SpawnY = 140; var StartX = -340; var StartY = 245;
/*
...
var Sector2X = 420; var Sector2Y = 225;
var Sector3X = 95;  var Sector3Y = -70;
...
"999    999                        9999999999999999999999999999999999999999999999999DDDDD999999999999\n"+ //1
"999UUUU99LL          Q           U 999999999999999999999999999999999999999999999999          9999999\n"+ //2
"999      Q 999999999999999999999 Q  999999999999999999999999999999999999999999999999          999999\n"+ //3
"999                                  99999999999999999999999999999999999999999999999999999    999999\n"+ //4
"999         L     B B B B B B         9999999999999999999999999999999999999999999999999999    999999\n"+ //5
"9999       L    I                   L  9999999999999999999999999999     L     999999999999    999999\n"+ //6
"99999       L      B B B B B B      L  99999999999999999999999999       L      99999999999    999999\n"+ //7
"999999                   L          L  9999999999999999999999999        L        999999999    999999\n"+ //8
"999999999999999999999999UUU999999999   999999999999999999999999        99999      99999999    999999\n"+ //9
"99999999999999999999999999   999999 U 999999999999999999999999        99999999     9999999    999999\n"+     //30
"999999999999999999999999999   9999   9999999999999999999999999  D D  9999999999     999999    999999\n"+ //1
"99999999999999999     999999UU9999         L    99999999999999   D   99999999999     99999    999999\n"+ //2
"99999999999999999     999999  9999         L      999999999999       999999999999     9999DDDD999999\n"+ //3
"99999999999999999     9   99  9999         L       999999999999       999999999999    9999    999999\n"+ //4
"99999999999999999     9   99UU99999        L        999999999999       99999999999    9999    999999\n"+ //5
"99999999999999999     9   9   99999999999999999  H   9999999999999      9999999999    9999    999999\n"+ //6
"99999999999999999             999999999999999999     99999999999999      999999999     99     999999\n"+ //7
"99999999999999999     99 999999999999999999999999     99999999999999      999999999    L     9999999\n"+ //8
"99999999999999999     99     99999999999999999999     999999999999999      999999999   L    99999999\n"+ //9
"99999999999999999     99     999999999999999999999     999999999999999      999999999  L   999999999\n"+    //40
"99999999999999999     99     999999999999999999999     9999999999999999     999999999999999999999999\n"+ //1
"99999999999999999     99     9999999999999999999999     999999999999999DDDDD999999999999999999999999\n"+ //2
"999999999999999999999999     9999999999999999999999     999999999999999     999999999999999999999999\n"+ //3
...
checkpoints: [
  ...
  {x:Sector2X,y:Sector2Y,direction:Math.PI*1.5,width:80}, // the 1st third end of track (2nd sector beginning)
  {x:Sector3X,y:Sector3Y,direction:Math.PI/2,width:100} // the 2nd third end of track (3rd sector beginning)
 ]
} ;
...
this.options = {
  ...
  starting_ship: 101,
  auto_refill: false,
  map_name: order+"SRC track/"+map_name_type,
  projectile_speed: 3,
...
var createStartingGrid = function(game) {
  var x = -311 ;// Pole position ship X coordinate
  ...
  for (var i=0;i<game.ships.length;i++)
  {
    ...
    if (i%2 ==0)
    {
      ship.set({x:x,y:255,vx:0,vy:0,idle:true,angle:0,generator:0}) ;
    }
    else
    {
      ship.set({x:x,y:235,vx:0,vy:0,idle:true,angle:0,generator:0}) ;
    }
    x = Math.min(-311,x+10) ; // (Pole position coordinate, x+10 / x-10 distance with position down)
  }
}
...
this.tick = function(game) {
  ...
  if (game.step%605 == 0) {
    //DRSZONE 1
    game.addCollectible({code:90,x:25,y:330});
    game.addCollectible({code:90,x:75,y:330});
    game.addCollectible({code:90,x:125,y:330});
    game.addCollectible({code:90,x:175,y:330});
    game.addCollectible({code:90,x:225,y:330});
    game.addCollectible({code:90,x:275,y:330});
    //DRSZONE 2
    game.addCollectible({code:90,x:75,y:-5});
    game.addCollectible({code:90,x:58,y:30});
    game.addCollectible({code:90,x:42,y:63});
    game.addCollectible({code:90,x:25,y:95});
    game.addCollectible({code:90,x:10,y:128});
  } 
  // PitLane
