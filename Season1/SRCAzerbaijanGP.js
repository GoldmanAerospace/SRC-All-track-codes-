...
var qualification_duration = 1660;
var race_laps = 16;
...
var Sector1X = StartX+60; var Sector1Y = StartY;
var Sector2X = 75; var Sector2Y = 85;
var Sector3X = -300;  var Sector3Y = -165;
...
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //29
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+     //30
"999999999999999999   L   999999999999999999999999999999999999999                       L          99\n"+ //31
"99999999999999999    L    9999999999999999999999999999999999999                        L           9\n"+ //32
"9999999999999999     L     999999999999999999999999999999999999      M             M   L           9\n"+ //33
"999999999999999     99     999999999999999999999999999999999999                        L           9\n"+ //34
"99999999999999     9999    999999999999999999999999999999999999    999999999999999999999999999     9\n"+ //35
"9999999999999     99999    999999999999999999999999999999999999   99999999999999999999999999999    9\n"+ //36
"999999999999     9999999   999999999999999999999999999999999999   99999999999999999999999999999    9\n"+ //37
"99999999999DDDDD99999999UUU999999999999999999999999999999999999DDD99999999999999999999999999999UUUU9\n"+ //38
"9999999999     999999999   999999999999999999999999999999999999   99999999999999999999999999999    9\n"+ //39
"999999999     9999999999   9999999999999999999999999999999999     99999999999999999999999999999    9\n"+    //40
"999999999     99999999999  999999999999999999999 L                99999999999999999999999999999    9\n"+ //41
"99999999     999999999999   9999999999999999999  L              9999999999999999999999999999999    9\n"+ //42
"99999999DDDDD9999999999999UUU99999999999999999   L            9999999999999999999999999999999 U    9\n"+ //43
"9999999     99999999999999    9999999999999      999999999999999999999999999999999999999999   U    9\n"+ //44
"999999     999999999999999    999999999         99999999999999999999 R                   R   99    9\n"+ //45
"999999     999999999999999    999999           9999999999999999999 U R         Q         R 9999UUUU9\n"+ //46
"99999     9999999999999999       L          9999999999999999999999 Q 9999999999999999999999999     9\n"+ //47
"99999    99999999999999999       L       999999999                                                 9\n"+ //48
"99999    999999999999999999      L    999999999                      B B B B B B B   R     R       9\n"+ //49
"99999    99999999999999999999999999999999999       T              T                I  R     R      9\n"+    //50
"99999    99999999999999999999999999999999                             B B B B B B    R     R       9\n"+ //1
"99999DDDD99999999999999999999999999999                                R                           99\n"+ //2
"99999    9999999999999999999999999999          9999999999999999999999   9999999999999999999999999999\n"+ //3
"99999     99999999999999999999999999      99999999999999999999999999UU999999999999999999999999999999\n"+ //4
"99999     9999999999999999999999999      99999999999999999999999999  9999999999999999999999999999999\n"+ //5
"999999     99999999999999999999999      999999999999999     9999999  9999999999999999999999999999999\n"+ //6
"999999     9999999999999999999999      9999999999999999     9999999UU9999999999999999999999999999999\n"+ //7
"9999999     99999999999999999999      99999999999999999     9   999  9999999999999999999999999999999\n"+ //8
"9999999     9999999999999999999      999999999999999999     9   99   9999999999999999999999999999999\n"+ //9
"99999999     99999999999999999      9999999999999999999     9   9    9999999999999999999999999999999\n"+    //60
"99999999DDDDD9999999999999999UUUUUU99999999999999999999              9999999999999999999999999999999\n"+ //11
"999999999     99999999999999      999999999999999999999     999 999999999999999999999999999999999999\n"+ //12
"9999999999     999999999999      9999999999999999999999     999     99999999999999999999999999999999\n"+ //13
"99999999999     9999999999      99999999999999999999999     999     99999999999999999999999999999999\n"+ //14
"999999999999     99999999      999999999999999999999999     999     99999999999999999999999999999999\n"+ //15
"9999999999999        R        9999999999999999999999999     999     99999999999999999999999999999999\n"+ //16
"99999999999999       R       99999999999999999999999999     999     99999999999999999999999999999999\n"+ //17
"999999999999999      R      999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //18
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //19
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+    //70
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //21
"9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //22
...
checkpoints: [
  {x:StartX,y:StartY,direction:0,width:120}, // Start/ finish line
  {x:Sector2X,y:Sector2Y,direction:180,width:80}, // the 1st third end of track (2nd sector beginning)
...
var createStartingGrid = function(game) {
  ...
  for (var i=0;i<game.ships.length;i++)
  {
    ...
    if (i%2 ==0)
    {
      ship.set({x:x,y:15,vx:0,vy:0,idle:true,angle:0,generator:0}) ;
    }
    else
    {
      ship.set({x:x,y:-5,vx:0,vy:0,idle:true,angle:0,generator:0}) ;
    }
    x = Math.min(309,x-10) ; // (Pole position coordinate, x+10 / x-10 distance with position down)
  }
}
