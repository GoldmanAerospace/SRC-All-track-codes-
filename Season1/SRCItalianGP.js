...
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+
"99999    R             9999999999999999999999999999999999999999999999999999999999999999999\n"+
"999      R           T    9999999999999999999999999999999999999999999999999999999999999999\n"+
"99      9999999999999      999999999999999999999999999999999999999999999999999999999999999\n"+ //1
"99    99999999999999999    999999999999999999999999999999999999999999999999999999999999999\n"+ //2
"99    99999999999999999     99999999999999999999999999999999999999999999999999999999999999\n"+ //3
"99    999999999999999999     9999999999999999999999999999999999999999999999999999999999999\n"+ //4
"99      9999999999999999     9999999999999999999999999999999999999999999999999999999999999\n"+ //5
"99999      99999999999999     999999999999999999999999999999999999999999999999999999999999\n"+ //6
"9999999     99999999999999     99999999999999999999999999999999999999999999999999999999999\n"+ //7
"9999999   99999999999999999     9999999999999999999999999999999999999999999999999999999999\n"+ //8
"999999UUU9999999999999999999      99999999999999999999999999999999999999999999999999999999\n"+ //9
"999999   999999999999999999999      999999999999999999999999999999999999999999999999999999\n"+    //10
"999999    9999999999999999999999      9999999999999999999999999999999999999999999999999999\n"+ //11
"999999    99999999999999999999999       99     R   999999999999999999999999999999999999999\n"+ //12
"999999    9999999999999999999999999   T       99         R              999999999999999999\n"+ //13
"99999UUUU9999999999999999999999999999      9999999       R                      9999999999\n"+ //14
"9999    99999999999999999999999999999999999999999999     R                    R      99999\n"+ //15
"999    99999999999999999999999999999999999999999999999999999999999999999999999999  H  9999\n"+ //16
"99    999999999999999999999999999999999999999999999999999999999999999999999999999  D  9999\n"+ //17
"99    9999999999999999999999999999999999999999999999999999999999999999999999999       9999\n"+ //18
"999UUUU99999999999999999999999999999999999999999999999999999999999999999999999       99999\n"+ //19
"999     999999999999999999999999999999999999999999999999999999999999999999999      9999999\n"+    //20
"9999     9999999999999999999999     9999999      99999999999999999999999999DDDDDDD99999999\n"+ //21
"99999      99999999999999       LU   9999              Q         999999        99999999999\n"+ //22
"999999         99              99U   999  999999999999999999999 U  999        999999999999\n"+ //23
"999999999                 9999999U     L     B B B B B B     L     9        99999999999999\n"+ //24
"9999999999999      99999999999999U     L   I                 L      M L  99999999999999999\n"+ //25
"999999999999999      9999D    99D      L      B B B B B B    L         9999999999999999999\n"+ //26
"9999999999999999999U      9U     9999999999999999999999999999999999999U9999999999999999999\n"+ //27
"9999999999999999999999999999999999999999999999999999999999999999----9UU9999999999999999999\n"+ //28
"9999999999999999999999999999999999999999999999999999999999999999-------9999999999999999999\n"+ //29
"9999999999999999999999999999999999999999999999999999999999999999-------9999999999999999999\n"+    //30
"9999999999999999999999999999999999999999999999999999999999999999-------9999999999999999999\n"+ //31
"999999999999999999999999999999999999999999999999999999    99    DD999999999999999999999999\n"+ //32
"999999999999999999999999999999999999999999999999999999          9RR    9999999999999999999\n"+ //33
"999999999999999999999999999999999999999999999999999999          99R    9999999999999999999\n"+ //34
"999999999999999999999999999999999999999999999999999999    99    99R    9999999999999999999\n"+ //35
"999999999999999999999999999999999999999999999999999999999999999999R    9999999999999999999\n"+ //36
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //37
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //38
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //39
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+    //40
...
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999\n"+
"999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999",      //70
checkpoints: [
  {x:-12.225,y:105.123,direction:180,width:100}, // Start/ finish line
  {x:-356,y:359,direction:0,width:40}, // the 1st third end of track (2nd sector beginning)
  {x:95,y:215,direction: 0,width:50} // the 2nd third end of track (3rd sector beginning)
 ]
} ;
...
var manageGame = function(game,second) {
  ...
  switch (game.custom.status)
  {
    case "qualification":
      ...
      {
        race_info.components[0].value = "30 min qualifying session. Firstly carefully explore the map, and then show your maximum..";
        race_info.visible = true ;
        game.setUIComponent(race_info);
      }
      break ;
...
var spawnShip = function(ship)
{
  var x = +243;
  var y = +62;
  ship.set({x:x,y:y,vx:0,vy:0,generator:0}) ;
}

var createStartingGrid = function(game) {
  var x = 10 ; // Pole position ship X coordinate
  ...
  for (var i=0;i<game.ships.length;i++)
  {
    ...
    if (i%2 ==0)
    {
      ship.set({x:x,y:115,vx:0,vy:0,idle:true,angle:180,generator:200}) ;
    }
    else
    {
      ship.set({x:x,y:95,vx:0,vy:0,idle:true,angle:180,generator:200}) ;
    }
    x = Math.max(10,x+10) ; // (Pole position coordinate, x+10 / x-10 distance with position down)
  }
}
...
this.tick = function(game) {
  ...
  if (game.step%605 == 0) {
    //DRSZONE 1
    game.addCollectible({code:90,x:-202,y:336});
    game.addCollectible({code:90,x:-178,y:298});
    game.addCollectible({code:90,x:-147,y:268});
    game.addCollectible({code:90,x:-98,y:242});
    //DRSZONE 2
    game.addCollectible({code:90,x:372,y:176});
    game.addCollectible({code:90,x:319,y:135});
    game.addCollectible({code:90,x:244,y:104});
  }

 // PITLANE
  if (game.step%1305 == 0) {  
    game.addCollectible({code:21,x:84.6,y:134.7});
    game.addCollectible({code:10,x:74.3,y:134.7});
    game.addCollectible({code:10,x:126,y:134.7});
    game.addCollectible({code:21,x:136,y:134.7});
  }
  else if (game.step%1305 == 650) {
    game.addCollectible({code:20,x:84.6,y:134.7});
    game.addCollectible({code:11,x:74.3,y:134.7});
    game.addCollectible({code:11,x:126,y:134.7});
    game.addCollectible({code:20,x:136,y:134.7});
  } 
