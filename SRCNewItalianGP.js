...
var SpawnX = 310; var SpawnY = -290; var StartX = 60; var StartY = -235;
/*
...
var Sector2X = -460; var Sector2Y = 120;
var Sector3X = 140;  var Sector3Y = -110;
...
"99    99999999999999DDDD9999999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //2
...
"99    999999999999999999    999999999999999999999999999999999999999999999999999999999999999999999999\n"+ //1
"99UUUU9999999999999999999    99999999999999999999999999999999999999999999999999999999999999999999999\n"+ //2
"99    9999999999999999999    99999999999999999999999999999999999999999999999999999999999999999999999\n"+ //3
"999    999999999999999999     9999999999999999999999999999999999999999999999999999999999999999999999\n"+ //4
"999     999999999999999999  H  999999999999999999999999999999999999999999999999999999999999999999999\n"+ //5
"99999      9999999999999999     99999999999999999999999999999999999999999999999999999999999999999999\n"+ //6
"9999999     9999999999999999     9999999999999999999999999999999999999999999999999999999999999999999\n"+ //7
"99999999LLLLL9999999999999999     999999999999999999999999999999999999999999999999999999999999999999\n"+ //8
"99999999     99999999999999999     99999999999999999999999999999999999999999999999999999999999999999\n"+ //9
"99999999     999999999999999999     9999999999999999999999999999999999999999999999999999999999999999\n"+    //50
"99999999     9999999999999999999     999999999999999999999999999999999999999999999999999999999999999\n"+ //1
"99999999     99999999999999999999     99999999999999999999999999999999999999999999999999999999999999\n"+ //2
"99999999     999999999999999999999     9999999999999999999999999999999999999999999999999999999999999\n"+ //3
"99999999     9999999999999999999999     999999999999999999999999999999999999999999999999999999999999\n"+ //4
"99999999     99999999999999999999999     99999999999999999999999999999999999999999999999999999999999\n"+ //5
"99999999     999999999999999999999999     9999999999999999999999999999999999999999999999999999999999\n"+ //6
"99999999UUUUU9999999999999999999999999     9999999    9999999999999999999999999999999999999999999999\n"+ //7
"99999999     99999999999999999999999999  H  9999        99999999999999999999999999999999999999999999\n"+ //8
"99999999     999999999999999999999999999     99           999999999999999999999999999999999999999999\n"+ //9
"99999999     9999999999999999999999999999  R   U  99   D             R                      99999999\n"+    //60
"99999999     99999999999999999999999999999       99999               R                   D    999999\n"+ //1
"99999999     999999999999999999999999999999     9999999              R                   D     99999\n"+ //2
"99999999     9999999999999999999999999999999999999999999             R                          9999\n"+ //3
"999999999     999999999999999999999999999999999999999999999999999999999999999999999999999999     999\n"+ //4
"999999999     9999999999999999999999999999999999999999999999999999999999999999999999999999999    999\n"+ //5
"9999999999UUUUU999999999999999999999999999999999999999999999999999999999999999999999999999999DDDD999\n"+ //6
"99999999999     9999999999999999999999    999999999999999999999999999999999999999999999999999    999\n"+ //7
"99999999999       99999999999999999        9999999999999999999999999999999999999999999999999     999\n"+ //8
"999999999999       9999999999999           999999999        99999999999       9999999999999     9999\n"+ //9
"99999999999999        9999999        9999LL999999                Q               99999999      99999\n"+    //70
"999999999999999          L        9999999  99999    999999999999999999999999      99999LLLLLLL999999\n"+ //1
"99999999999999999        L     9999999999  U                                                 9999999\n"+ //2
"999999999999999999       L  9999999999999  UU   L        B B B B B B                       999999999\n"+ //3
"99999999999999999999     L999999999999999      L       I                 T         T     99999999999\n"+ //4
"9999999999999999999999   L 99       9           L         B B B B B B                  9999999999999\n"+ //5
"9999999999999999999999999        9     9  L                                         9999999999999999\n"+ //6
"999999999999999999999999999999999999999999999999999999999999999999999999999 LLLL 9999999999999999999\n"+ //7
...
checkpoints: [
  {x:StartX,y:StartY,direction:Math.PI,width:100}, // Start / finish line
  {x:Sector2X,y:Sector2Y,direction:Math.PI*0.5,width:100}, // the 1st third end of track (2nd sector beginning)
...
var TrackInfo = {
  id: "TrackInfo",
  obj: "https://starblast.data.neuronality.com/mods/objects/plane.obj",
  diffuse: "https://raw.githubusercontent.com/mrGoldmanus/RACING-/master/abouttrackITA.png",
  emissive: "https://raw.githubusercontent.com/mrGoldmanus/RACING-/master/abouttrackITA.png"
} ;
...
var createStartingGrid = function(game) {
  ...
  var x = 79 ;// Pole position ship X coordinate
  ...
  for (var i=0;i<game.ships.length;i++)
  {
    ...
    {
      ship.set({x:x,y:-245,vx:0,vy:0,idle:true,angle:180,generator:200}) ;
    }
    x = Math.max(77,x+10); // (Pole position coordinate, x+10 / x-10 distance with position down)
  }
}
...
this.tick = function(game) {
  ...
  if (game.custom.enable_drs) {
    if (game.step%400 == 0) {
      //DRSZONE 1
      game.addCollectible({code:90,x:325,y:-235});
      game.addCollectible({code:90,x:305,y:-235});
      game.addCollectible({code:90,x:285,y:-235});
      game.addCollectible({code:90,x:265,y:-235});
      game.addCollectible({code:90,x:245,y:-235});
      //DRSZONE 2
      game.addCollectible({code:90,x:-210,y:50});
      game.addCollectible({code:90,x:-190,y:30});
      game.addCollectible({code:90,x:-170,y:10});
      game.addCollectible({code:90,x:-150,y:-10});
      game.addCollectible({code:90,x:-130,y:-30});
      game.addCollectible({code:90,x:-110,y:-50});
      //Pitlane_booster
      game.addCollectible({code:90,x:215,y:-195});
    }
  }
